import { d as dispatch$1, R as Rgb$1, r as rgbConvert$1, a as define$1, e as extend$1, C as Color$1, b as brighter$1, c as darker$1, f as constant$b, i as interpolateNumber, g as color$1, h as interpolateRgb, j as interpolateString, n as nogamma$1, k as hue$2, t as timer$1, l as timeout$2, m as interpolateTransformSvg$1, o as interpolateTransformCss$1, p as now$1, q as cubicInOut$1, s as rgbBasis$1, u as rgb$2, v as interpolateZoom } from './common/cubic-c714ef8b.js';
import { c as clipRectangle, g as geoStream, n as noop$3, a as atan2$1, s as sqrt$2, A as Adder$1, b as sin$2, d as cos$2, r as radians$1, e as abs$3, p as polygonContains, f as epsilon2$1, h as epsilon$5, i as ceil, t as tau$5, j as boundsStream, k as identity$9, l as projectionMutator, m as degrees$2, o as pi$4, q as asin$1, u as sign$1, v as fitExtent, w as fitSize, x as fitWidth, y as fitHeight, z as log$1, B as tan, C as halfPi$3, D as atan, E as exp, F as projection, G as rotation, H as pow$2, I as equirectangularRaw, J as transformer$3, K as azimuthalInvert } from './common/orthographic-18b0093e.js';
export { L as geoArea, S as geoAzimuthalEqualArea, T as geoAzimuthalEqualAreaRaw, U as geoAzimuthalEquidistant, V as geoAzimuthalEquidistantRaw, M as geoBounds, N as geoCentroid, O as geoCircle, P as geoClipAntimeridian, Q as geoClipCircle, c as geoClipRectangle, W as geoEquirectangular, I as geoEquirectangularRaw, X as geoGnomonic, Y as geoGnomonicRaw, R as geoInterpolate, Z as geoOrthographic, _ as geoOrthographicRaw, F as geoProjection, l as geoProjectionMutator, G as geoRotation, g as geoStream, $ as geoTransform } from './common/orthographic-18b0093e.js';
...
define(Cubehelix$1, cubehelix$2, extend(Color, {
  brighter: function(k) {
    k = k == null ? brighter : Math.pow(brighter, k);
...
const tau$2 = 2 * Math.PI, pow = Math.pow;
...
function graticuleX(y0, y1, dy) {
  var y = range$3(y0, y1 - epsilon$5, dy).concat(y1);
  return function(x) { return y.map(function(y) { return [x, y]; }); };
}

function graticuleY(x0, x1, dx) {
  var x = range$3(x0, x1 - epsilon$5, dx).concat(x1);
...
function graticule() {
  ...
  function lines() {
    return range$3(ceil(X0 / DX) * DX, X1, DX).map(X)
        ...
        .concat(range$3(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs$3(x % DX) > epsilon$5; }).map(x))
        .concat(range$3(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs$3(y % DY) > epsilon$5; }).map(y));
  }
...
function lengthPoint$1(x, y) {
  x0$2 -= x, y0$2 -= y;
  lengthSum$1.add(sqrt$2(x0$2 * x0$2 + y0$2 * y0$2));
  x0$2 = x, y0$2 = y;
}
...
function index$2(projection, context) {
  ...
  path.projection = function(_) {
    return arguments.length ? (projectionStream = _ == null ? (projection = null, identity$9) : (projection = _).stream, path) : projection;
  };
...
function identity$3() {
  ...
  projection.clipExtent = function(_) {
    return arguments.length ? (postclip = _ == null ? (x0 = y0 = x1 = y1 = null, identity$9) : clipRectangle(x0 = +_[0][0], y0 = +_[0][1], x1 = +_[1][0], y1 = +_[1][1]), reset()) : x0 == null ? null : [[x0, y0], [x1, y1]];
  };
...
var cubehelixLong$1 = cubehelix$3(nogamma);
...
function quantileSorted$1(values, p, valueof = number$3) {
  if (!(n = values.length)) return;
  if ((p = +p) <= 0 || n < 2) return +valueof(values[0], 0, values);
  if (p >= 1) return +valueof(values[n - 1], n - 1, values);
  var n,
...
function continuous() {
  return transformer()(identity$5, identity$5);
}
...
var ramp = scheme => rgbBasis$1(scheme[scheme.length - 1]);
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1,
      ...
      r = r1 - rc,
      D = x11 * y10 - x10 * y11,
      d = (dy < 0 ? -1 : 1) * sqrt$1(max$5(0, r * r * d2 - D * D)),
      cx0 = (D * dy - dx * d) / d2,
      cy0 = (-D * dx - dy * d) / d2,
      cx1 = (D * dy + dx * d) / d2,
      cy1 = (-D * dx + dy * d) / d2,
...
function symbol(type, size) {
  var context = null;
  type = typeof type === "function" ? type : constant$9(type || circle$1);
