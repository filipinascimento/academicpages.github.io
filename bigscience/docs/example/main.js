...
export class HeliosMap {
	...
	async initialize() {
		...
		let network = await xnet.loadXNETFile("data/institutions_ATLAS.xnet")
	...
	async willResizeEvent() {
		...
		this.canvasElement.width = this.contextPixelRatio * this.element.clientWidth;
		this.canvasElement.height = this.contextPixelRatio * this.element.clientHeight;
